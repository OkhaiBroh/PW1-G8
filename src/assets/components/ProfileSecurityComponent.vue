<template>
  <div class="security-container box-shadow">
    ...
    <div class="inputs-container">
      ...
      <div class="container">
        <label class="input-text" for="confnew_password">
          Confirm Password
        </label>
        <input
          v-model="confnew_password"
          class="input"
          type="text"
          name="confnew_password"
          id="confnew_password"
        />
      </div>
    </div>
    <div class="save-changes-container">
      <button
        ...
        class="save-changes margin-btn-password"
      >
        Change Password
      </button>
    </div>
...
export default {
  ...
  methods: {
    UpdatePassword() {
      ...
      console.log(
        "newpass: " + this.new_password + " confpass: " + this.confnew_password
      );
